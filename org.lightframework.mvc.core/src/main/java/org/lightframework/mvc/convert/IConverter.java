...
public interface IConverter {
	 ...
	 * @param type {@link Argument}
	 * @param string string value
	 * @return translated value of the given {@link Argument}
	 */
	Object convertToObject(Argument type,String string) throws BindingException,Exception;
